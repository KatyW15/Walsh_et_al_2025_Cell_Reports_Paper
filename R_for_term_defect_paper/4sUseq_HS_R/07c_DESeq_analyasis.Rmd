...
format:
  geneID   NHS_rep1     NHS_rep2     NHS_rep3     HS_rep1      HS_rep2      HS_rep3
  <ID#>    <counts #>   <counts #>   <counts #>   <counts #>   <counts #>   <counts #>
  
```{r making DESeq counts matrix}
#read-in bed files from bedtools coverage output
fl_gnbd <- list.files("/Users/goodrichlab/Desktop/Katy/HS_4sU-Seq_2021/07_analysis/07a_gene_and_ds_counts/Bed_Tools_20kb_ds_counts_unnorm/gnbd", 
                  pattern = "*_counts.bed",
                  full.names = TRUE)
gnbd_counts <- lapply(fl_gnbd, read.table, header = FALSE, sep="\t",stringsAsFactors=FALSE, quote="")
names(gnbd_counts) <- gsub("/Users/goodrichlab/Desktop/Katy/HS_4sU-Seq_2021/07_analysis/07a_gene_and_ds_counts/Bed_Tools_20kb_ds_counts_unnorm/gnbd/|_gnbd_counts.bed", "", fl_gnbd)


fl_20kbds <- list.files("/Users/goodrichlab/Desktop/Katy/HS_4sU-Seq_2021/07_analysis/07a_gene_and_ds_counts/Bed_Tools_20kb_ds_counts_unnorm/ds_20kb", 
                  pattern = "*_counts.bed",
                  full.names = TRUE)
ds_20kb_counts <- lapply(fl_20kbds, read.table, header = FALSE, sep="\t",stringsAsFactors=FALSE, quote="")
names(ds_20kb_counts) <- gsub("/Users/goodrichlab/Desktop/Katy/HS_4sU-Seq_2021/07_analysis/07a_gene_and_ds_counts/Bed_Tools_20kb_ds_counts_unnorm/ds_20kb/|_ds_counts.bed", "", fl_20kbds)

#pull out counts and add as col in counts matrix
gnbd_counts_matrix <- data.frame(geneID = gnbd_counts$rep1_NHS$V4, 
                                 NHS_rep1 = gnbd_counts$rep1_NHS$V7,
                                 NHS_rep2 = gnbd_counts$rep2_NHS$V7,
                                 NHS_rep3 = gnbd_counts$rep3_NHS$V7,
                                 HS_rep1 = gnbd_counts$rep1_HS$V7,
                                 HS_rep2 = gnbd_counts$rep2_HS$V7,
                                 HS_rep3 = gnbd_counts$rep3_HS$V7
                                 )

ds_counts_matrix <- data.frame(geneID = ds_20kb_counts$rep1_NHS$V4, 
